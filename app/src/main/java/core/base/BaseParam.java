...
public abstract class BaseParam implements Param {
     ...
     * needed values
     *
     * @return a set of key-value(s) parameters for the request. In case of multiple values header,
     * one header will hold an array of values separated by comma.
     * For example, Key: value 1, value 2, value 3, etc.
     */
