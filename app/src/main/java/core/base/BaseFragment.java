...
//        BaseApplication.getRefWatcher().watch(this);
    ...
    public final void showAlertDialog(Context context, int id, @LayoutRes int layout, @DrawableRes int icon,
        ...
        getWorkingActivity().showAlertDialog(activeActivity, id, getGeneralDialogLayoutResource(), icon,
    ...
    public final void showLoadingDialog(Context context, @LayoutRes int layout, String loading) {
        getWorkingActivity().showLoadingDialog(activeActivity, getLoadingDialogLayoutResource(), loading);
    }
    ...
    public final void showDecisionDialog(Context context, int id, @LayoutRes int layout, @DrawableRes int icon,
        ...
        getWorkingActivity().showDecisionDialog(activeActivity, id, getGeneralDialogLayoutResource(), 0,
    ...
    public int getGeneralDialogLayoutResource() {
        return getWorkingActivity().getGeneralDialogLayoutResource();
    }

    @LayoutRes
    @Override
    public int getLoadingDialogLayoutResource() {
        return getWorkingActivity().getLoadingDialogLayoutResource();
    }
